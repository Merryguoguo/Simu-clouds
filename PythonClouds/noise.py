...
class SimplexNoiseGen(object):
    # def __init__(self, seed, octaves=6, zoom_level=0.002):  # OG
    def __init__(self, seed, octaves=8, zoom_level=0.002):  # 512_4
    # def __init__(self, seed, octaves=79, zoom_level=0.008):  
        perm = list(range(255))
        random.Random(seed).shuffle(perm)
        self.noise = SimplexNoise(permutation_table=perm).noise2

        self.PERSISTENCE = 2.1379201 # AKA lacunarity # OG
        # self.PERSISTENCE = 4.1379201 # AKA lacunarity # 512_4
        # self.PERSISTENCE = 104.1379201 # AKA lacunarity
        # self.PERSISTENCE = 14.1379201 # AKA lacunarity
        # self.H = 0.836281 # OG
        self.H = 1.236281 # 512_4
        # self.H = 91.236281
